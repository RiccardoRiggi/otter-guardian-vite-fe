...
export default function HomePage() {
    ...
    const getStatisticheMetodi = async () => {
        ...
        await statisticheService.getStatisticheMetodi(utenteLoggato.token).then((response: any) => {
    ...
    const getNumeroVociMenu = async () => {
        await statisticheService.getNumeroVociMenu(utenteLoggato.token).then((response: any) => {
    ...
    const getNumeroRuoli = async () => {
        await statisticheService.getNumeroRuoli(utenteLoggato.token).then((response: any) => {
    ...
    const getNumeroUtenti = async () => {
        await statisticheService.getNumeroUtenti(utenteLoggato.token).then((response: any) => {
    ...
    const getNumeroAccessiAttivi = async () => {
        await statisticheService.getNumeroAccessiAttivi(utenteLoggato.token).then((response: any) => {
    ...
    const getNumeroRisorse = async () => {
        await statisticheService.getNumeroRisorse(utenteLoggato.token).then((response: any) => {
    ...
    const getNumeroLogin = async () => {
        await statisticheService.getNumeroLogin(utenteLoggato.token).then((response: any) => {
    ...
    const getNumeroIndirizziIp = async () => {
        await statisticheService.getNumeroIndirizziIp(utenteLoggato.token).then((response: any) => {
    ...
    const getNumeroDispositiviFisiciAttivi = async () => {
        await statisticheService.getNumeroDispositiviFisiciAttivi(utenteLoggato.token).then((response: any) => {
                        ...
                        <div className="card-body">
                            <div >
                                ...
                                <div className='row'>
                                    ...
                                    {
                                        Array.isArray(statistiche) && statistiche.map((statistica: any) =>
